...
export const getProductList_json = async () => {
    ...
    try {
      ...
      await writeFile('./top_products_by_category.json', JSON.stringify(list, null, 2));
      console.log('Data has been written to top_products_by_category.json successfully');
      return list;
    } catch (error) {
